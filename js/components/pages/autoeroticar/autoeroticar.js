                ...
                <div className="container mb-5" id="trademarks-display">
                    ...
                    <div className="row">
                        <div className="col-md-6 d-flex flex-row col-left">
                            <div className="trademark-logo" id="trl-1">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                                    ...
                                    <defs>
                                        <linearGradient id="MyGradient" gradientTransform="rotate(75)">
                                            <stop offset="35%" stopColor="#f1f1f3" />
                                            <stop offset="65%" stopColor="#959799" />
                                            <stop offset="99%" stopColor="#f1f1f3" />
                                        </linearGradient>
                                        <linearGradient id="SelectedGradient" gradientTransform="rotate(75)">
                                            <stop offset="35%" stopColor="#ffb425" />
                                            <stop offset="65%" stopColor="#fffbaf" />
                                            <stop offset="99%" stopColor="#ffb425" />
                                        </linearGradient>
                                    </defs>
                                </svg>
                            </div>
                            <div className="trademark-logo" id="trl-2">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                            ...
                            <div className="trademark-logo" id="trl-3">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                            ...
                            <div className="trademark-logo" id="trl-4">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    width="0.853333in" height="0.853333in"
                                    viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                        ...
                        <div className="col-md-6 d-flex flex-row col-right">
                            <div className="trademark-logo" id="trl-5">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                            ...
                            <div className="trademark-logo" id="trl-6">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                            ...
                            <div className="trademark-logo" id="trl-7">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
                            ...
                            <div className="trademark-logo" id="trl-8">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                        width="0.853333in" height="0.853333in"
                                        viewBox="0 0 256 256">
                                    <path className="svg-trademark"
