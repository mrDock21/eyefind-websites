...
var BeanMachineCoffee = function (_React$Component) {
    ...
    _createClass(BeanMachineCoffee, [{
        ...
        value: function render() {
            ...
            var headerTittles = ["Home", "Specials", "Cup Sizes", "Franchising Opportunities", "Buy Our Coffees", "Caffeine Is Not a Drug", "Become a Rep", "10 Reasons To Boycott Your Local Coffeehouse"];
            var headerBtns = headerTittles.map(function (val, index) {
